...
class HrPayslip(models.Model):
    ...
    _sql_constraints = [(
        ...
        'Payslip Already generated for this employee for selected Month !',
    )]

    unpaid_leave = fields.Char(string="Unpaid Leave",compute="_onchange_employee_id_for_unpaid",)
    ...
    def get_worked_day_lines(self, contracts, date_from, date_to):
        ...
        for contract in contracts.filtered(lambda contract: contract.resource_calendar_id):
            ...
            # reference_calendar = contract.resource_calendar_id
    ...
    def onchange_employee(self):
        ...
        #         if rec.code == 'Unpaid':
        #             self.unpaid_leave = rec.number_of_days
    ...
    def _onchange_employee_id_for_unpaid(self):
        print(f"\n\n\n\t--------------> 533 ",)
        for rec in self:
            rec.unpaid_leave = False 
            if rec.employee_id and rec.worked_days_line_ids:
                for line in rec.worked_days_line_ids:
                    if line.code == 'Unpaid':
                        self.unpaid_leave = line.number_of_days
