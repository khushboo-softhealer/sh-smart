...
class res_users(models.Model):
    ...
    sh_disable_auto_edit_model = fields.Boolean("Disable Auto Save mode",default=False)
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        info["sh_hide_full_width"]=user.sh_hide_full_width
        return info
