...
class ShPortalChatter(PortalChatter):
    ...
    def portal_chatter_post(self, res_model, res_id, message, attachment_ids=None, attachment_tokens=None, **kw):
        ...
        # ---------------------------------------------------------------------------------------------
        # FOR STOP ASSIGN SUPPORT TEAM AUTOR WHILE PORTAL USER SENT MESSAGE FROM PORTAL CHATTER
        # ---------------------------------------------------------------------------------------------
        
        post_values.update({'from_portal_chatter':True})  
