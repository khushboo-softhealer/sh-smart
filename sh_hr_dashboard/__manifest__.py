...

{
    ...
    'support': 'support@softhealer.com(Nirali Softhealer)',
    ...
    'depends': [
        ...
        'hr_recruitment',
        'hr_timesheet',
        'sh_attendance_modification_request',
        'sh_hr_payroll',
        'sh_emp_complain',
        'sh_emp_idea',
    ...
    'data': [
        ...
        'views/datas_templates.xml',
        'views/annoucement_views.xml',
        'views/hr_dashboard_views.xml',
        # 'views/hr_employee_views.xml',
    ],
    'assets': {'web.assets_backend':
               [
                   'sh_hr_dashboard/static/src/xml/**/*',
                   'sh_hr_dashboard/static/src/css/sh_deshboard.css',
                   'sh_hr_dashboard/static/src/js/hr_dashboard.js',
               ]},
