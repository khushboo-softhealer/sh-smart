odoo.define("theme_mobiheal_website.s_offer", function (require) {
    "use strict";

    const publicWidget = require("web.public.widget");

    const ShOneMateOfferSnippetCountDown = publicWidget.Widget.extend({
        selector: ".js_cls_mb_app_launch_section",
    ...
    publicWidget.registry.ShOneMateOfferSnippetCountDown = ShOneMateOfferSnippetCountDown;
    return ShOneMateOfferSnippetCountDown;
});