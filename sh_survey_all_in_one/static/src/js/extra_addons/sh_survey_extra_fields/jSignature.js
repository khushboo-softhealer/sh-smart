            ...
            if (positionInStroke > 1) {
                ...
                if (BCvector.getLength() > this.lineCurveThreshold) {
                    ...
                    var minlenfraction = 0.05,
                        ...
                        BCP1vector = new Vector(ABvector.x + BCvector.x, ABvector.y + BCvector.y).resizeTo(Math.max(minlenfraction, ABCangle) * maxlen),
                        CCP2vector = new Vector(BCvector.x + CDvector.x, BCvector.y + CDvector.y).reverse().resizeTo(Math.max(minlenfraction, BCDangle) * maxlen);

                    basicCurve(this.canvasContext, Bpoint.x, Bpoint.y, Cpoint.x, Cpoint.y, Bpoint.x + BCP1vector.x, Bpoint.y + BCP1vector.y, Cpoint.x + CCP2vector.x, Cpoint.y + CCP2vector.y);
                }
            }
            ...
            if (positionInStroke > 0) {
                ...
                if (BCvector.getLength() > this.lineCurveThreshold) {
                    ...
                    if (positionInStroke > 1) {
                        ...
                        basicCurve(this.canvasContext, Bpoint.x, Bpoint.y, Cpoint.x, Cpoint.y, Bpoint.x + BCP1vector.x, Bpoint.y + BCP1vector.y, Cpoint.x, Cpoint.y);
                    } else {
...
*/
    ...
    function jSignatureClass(parent, options, instanceExtensions) {
        ...
        this.$controlbarUpper = (function () {
            var controlbarstyle = "padding:0 !important; margin:0 !important;" + "width: 100% !important; height: 0 !important; -ms-touch-action: none; touch-action: none;" + "margin-top:-1em !important; margin-bottom:1em !important;";
        ...
        settings.lineWidth = (function (defaultLineWidth, canvasWidth) {
            if (!defaultLineWidth) {
                return Math.max(Math.round(canvasWidth / 400) /*+1 pixel for every extra 300px of width.*/, 2 /* minimum line width */);
            } else {
        ...
        var movementHandlers = function (jSignatureInstance) {
            ...
            var shiftX,
                ...
                getPointFromEvent = function (e) {
                    ...
                    return new Point(Math.round(firstEvent.pageX + shiftX), Math.round(firstEvent.pageY + shiftY) + jSignatureInstance.fatFingerCompensation);
                },
        ...
        (function (drawEndHandler, drawStartHandler, drawMoveHandler) {
            ...
            if (this.isCanvasEmulator) {
                ...
                this.ontouchstart = function (e) {
                    ...
                    this.fatFingerCompensation = settings.minFatFingerCompensation && settings.lineWidth * -3 > settings.minFatFingerCompensation ? settings.lineWidth * -3 : settings.minFatFingerCompensation;
        ...
        eventTokens[apinamespace + ".windowmouseup"] = globalEvents.subscribe(apinamespace + ".windowmouseup", movementHandlers.drawEndHandler);
        ...
        conditionallyLinkCanvasResizeToWindowResize.call(this, this, settings.width.toString(10), apinamespace, globalEvents);
    ...
    jSignatureClass.prototype.resetCanvas = function (data, dontClear) {
        ...
        var dataEngine = (this.dataEngine = new DataEngine(data, this, strokeStartCallback, strokeAddCallback, strokeEndCallback));
    ...
    function initializeCanvasEmulator(canvas) {
        if (canvas.getContext) {
            ...
            var FC = window.FlashCanvas ? canvas.ownerDocument.parentWindow.FlashCanvas : typeof FlashCanvas === "undefined" ? undefined : FlashCanvas;
		...
		*/
        ...
        var exportplugins = {
            ...
            image: function (data) {
                ...
                if (typeof imagestring === "string" && imagestring.length > 4 && imagestring.slice(0, 5) === "data:" && imagestring.indexOf(",") !== -1) {
        ...
        function _renderImageOnCanvas(data, formattype, rerendercallable) {
            ...
            img.onload = function () {
                ...
                ctx.drawImage(img, 0, 0, img.width < c.width ? img.width : c.width, img.height < c.height ? img.height : c.height);
