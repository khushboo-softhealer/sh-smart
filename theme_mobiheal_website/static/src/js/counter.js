odoo.define('theme_mobiheal_website.jsClsCounterHomePage', function (require) {
    'use strict';
    ...
    publicWidget.registry.jsClsCounterHomePage = animations.Animation.extend({
        selector: ".js_cls_sh_odometer_snippet_s_odometer",
