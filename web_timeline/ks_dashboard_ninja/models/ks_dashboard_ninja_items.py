        ...
        try:
            if ks_domain and ks_domain != '[]' and ks_model_name:
                ...
                if ks_func == 'search_count':
                    ...
                    if rec.ks_record_count_type:
                        data = self.env[ks_model_name].read_group(proper_domain, [rec.ks_record_field.name+":sum"], [], lazy=False)
                    else:
        ...
        try:
            if ks_domain and ks_domain != '[]' and ks_model_name:
                ...
                if ks_func == 'search_count':
                    ...
                    if rec.ks_record_count_type:
                        data = self.env[ks_model_name].read_group(proper_domain, [rec.ks_record_field_2.name+":sum"], [], lazy=False)
                    else:
