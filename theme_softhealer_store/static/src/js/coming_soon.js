odoo.define("theme_softhealer_store.SHOfferSnippetCountDownStore", function (require) {
    "use strict";

    const publicWidget = require("web.public.widget");

    const SHOfferSnippetCountDownStore = publicWidget.Widget.extend({
        selector: ".js_cls_sh_offer_snippet_store",
        ...
        start: function () {     
        	...
        	this.endTime = this.el.dataset.endDate;    
        ...
        _updateTimeLeft: function () {
            ...
            var delta =  unixTimestamp - currentTimestamp;
            this.timeLeft = delta;
            this.isFinished = delta < 0;
            this.isStarted = currentTimestamp;            
        },
    ...
    publicWidget.registry.SHOfferSnippetCountDownStore = SHOfferSnippetCountDownStore;

    return SHOfferSnippetCountDownStore;
});
