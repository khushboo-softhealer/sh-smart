$(document).ready(function(e) {
	...
	$.get('/get-ticket-table-data', 
			{'team':$('#team').val(),'team_leader':$('#team_leader').val(),'user_id':$('#assign_user').val(),'filter_date':$('#days_filter').children("option:selected").val(),
			'date_start':$('#start_date').val(),'date_end':$('#end_date').val(),
			}
					,function(result)
					{		
						$("#js_ticket_tbl_div").replaceWith(result);
				});
	$.get('/get-ticket-counter-data', 
			{'team':$('#team').val(),'team_leader':$('#team_leader').val(),'user_id':$('#assign_user').val(),'filter_date':$('#days_filter').children("option:selected").val(),
			'date_start':$('#start_date').val(),'date_end':$('#end_date').val(),
			}
					,function(result)
