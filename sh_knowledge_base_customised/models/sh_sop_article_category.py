...
class SopCategory(models.Model):
    _name = 'sh.sop.article.categories'
    _description = "SOP Article Category"
    ...
    parent_id = fields.Many2one("sh.sop.article.categories",string="Parent Categories", index=True, ondelete='cascade')
    child_id = fields.One2many('sh.sop.article.categories', 'parent_id', string='Children Categories')
